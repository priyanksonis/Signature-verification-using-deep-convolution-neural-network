...
PATH='/media/priyank/6442175942172F741/dataset_toy/development/'
save_PATH='/media/priyank/6442175942172F741/dataset_toy_processed/development'
...
for i in users:
       ...
       for j in images:
          ...
          normalized = 255 - normalize_image(original, size=(840, 1360))
          #normalized = 255 - normalized    ##inverting
          resized = resize_image(normalized, (170, 242))
          cropped = crop_center(resized, (150,220))

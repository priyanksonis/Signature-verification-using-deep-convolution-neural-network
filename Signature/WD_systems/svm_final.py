...
img_data_list=[]
img_list=os.listdir('/media/priyank/6442175942172F741/dataset1000_processed_features/exploitation/')
len(img_list)
#i=0
#j=0
x=0
for img in img_list:
   ...
   if "forg" not in img: 
       #print(img)
       input_img=loadmat('/media/priyank/6442175942172F741/dataset1000_processed_features/exploitation'+'/'+img)['features'] #input_img.shape
       ...
       X_test_FAR=loadmat('/media/priyank/6442175942172F741/dataset1000_processed_features/exploitation/forg_'+real_no)['features']
       y_test_FAR=(np.matlib.zeros(30)).T # y_test_FAR.shape   
       img_list_dev=os.listdir('/media/priyank/6442175942172F741/dataset1000_processed_features/development/')
       len(img_list_dev)
       ...
       for img1 in img_list_dev:
             if "forg" not in img1: 
               #print(img)
                   #print('a=',a)
                   #a=a+1
                   input_img=loadmat('/media/priyank/6442175942172F741/dataset1000_processed_features/development'+'/'+img1)['features']
                   np.random.shuffle(input_img)

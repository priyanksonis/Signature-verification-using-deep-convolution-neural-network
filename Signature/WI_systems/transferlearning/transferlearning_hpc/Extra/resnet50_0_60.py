...
testdata_x=X_test[:30]
testdata_y=y_test[:30]
...
(loss, accuracy) = custom_resnet_model.evaluate(testdata_x, testdata_y, batch_size=10, verbose=1)

print("[INFO] loss={:.4f}, accuracy: {:.4f}%".format(loss,accuracy * 100))

custom_resnet_model.save('/home/ee/mtech/eet162639/majorproject/resnet50_0_60.h5')
...
fig.savefig('/home/ee/mtech/eet162639/majorproject/resnet50_0_60_1.png')
...
#print plt.style.available # use bmh, classic,ggplot for big pictures
plt.style.use(['classic'])
fig1.savefig('/home/ee/mtech/eet162639/majorproject/resnet50_0_60_2.png')

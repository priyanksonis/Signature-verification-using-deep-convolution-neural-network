...
def SVM_WD_Train_Test(X_train,y_train,X_test_FRR,y_test_FRR,X_test_FAR,y_test_FAR):
    ...
    return prob,class1, class2, FRR,FAR
    
img_data_list=[]
img_list=os.listdir('/home/ee/mtech/eet162639/majorproject/final/dataset1000_processed_features_CNN_synthetic/exploitation/')
len(img_list)
#i=0
#j=0
x=0
for img in img_list:
   ...
   if "forg" not in img: 
       print('now'+ img)
       input_img=loadmat('/home/ee/mtech/eet162639/majorproject/final/dataset1000_processed_features_CNN_synthetic/exploitation'+'/'+img)['features'] #input_img.shape
       ...
       X_test_FAR=loadmat('/home/ee/mtech/eet162639/majorproject/final/dataset1000_processed_features_CNN_synthetic/exploitation/forg_'+real_no)['features']
       y_test_FAR=(np.matlib.zeros(30)).T # y_test_FAR.shape   
       img_list_dev=os.listdir('/home/emblab/dataset1000_processed_features_CNN_synthetic/development/')
       len(img_list_dev)
       ...
       for img1 in img_list_dev:
             if "forg" not in img1: 
               #print(img)
                   #print('a=',a)
                   #a=a+1
                   input_img=loadmat('/home/ee/mtech/eet162639/majorproject/final/dataset1000_processed_features_CNN_synthetic/development'+'/'+img1)['features']
                   np.random.shuffle(input_img)
       ...
       a=a+1
       prob,class1, class2,frr,far=SVM_WD_Train_Test(X_train,y_train,X_test_FRR,y_test_FRR,X_test_FAR,y_test_FAR)
       overall_FRR+=frr
       overall_FAR+=far
   if x==3:
     break     

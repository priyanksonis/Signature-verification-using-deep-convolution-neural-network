...
def SVM_WD_Train_Test(X_train,y_train,X_test_FRR,y_test_FRR,X_test_FAR,y_test_FAR):
    ...
    clf = svm.SVC(C=1,kernel='linear',gamma=pow(2,-12) )
    clf.fit(x,y)  
...
img_data_list=[]
img_list=os.listdir('/home/priyank/Desktop/project_priyank/my_project/gpds_signet_f/exploitation/')
len(img_list)
#i=0
#j=0
x=0
for img in img_list:
   ...
   if "forg" not in img: 
       #print(img)
       input_img=loadmat('/home/priyank/Desktop/project_priyank/my_project/gpds_signet_f/exploitation'+'/'+img)['features'] #input_img.shape
       ...
       X_test_FAR=loadmat('/home/priyank/Desktop/project_priyank/my_project/gpds_signet_f/exploitation/forg_'+real_no)['features']
       y_test_FAR=(np.matlib.zeros(30)).T # y_test_FAR.shape   
       img_list_dev=os.listdir('/home/priyank/Desktop/project_priyank/my_project/gpds_signet_f/development/')
       len(img_list_dev)
       ...
       for img1 in img_list_dev:
             if "forg" not in img1: 
               #print(img)
                   #print('a=',a)
                   #a=a+1
                   input_img=loadmat('/home/priyank/Desktop/project_priyank/my_project/gpds_signet_f/development'+'/'+img1)['features']
                   np.random.shuffle(input_img)
